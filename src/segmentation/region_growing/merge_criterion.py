...
def algebric_rgb(mean_vector, std_vector, chunk_mean_vector, chunk_std_vector, c):
    if (mean_vector[0] - std_vector[0] * c <= chunk_mean_vector[0] <= mean_vector[0] + std_vector[0] * c) and (
            mean_vector[1] - std_vector[1] * c <= chunk_mean_vector[1] <= mean_vector[1] + std_vector[1] * c) and (
            mean_vector[2] - std_vector[2] * c <= chunk_mean_vector[2] <= mean_vector[2] + std_vector[2] * c):
        return True
    else:
        return False
